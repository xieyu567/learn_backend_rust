...
async fn subscribe_returns_a_400_when_data_is_missing() {
    ...
    let client = reqwest::Client::new();
    let test_cases = vec![
        ("name=xieyu", "missing the email"),
        ("email=xieyu%40gmail.com", "missing the name"),
...
async fn subscribe_returns_a_400_when_fields_are_present_but_invalid() {
    ...
    let client = reqwest::Client::new();
    let test_cases = vec![
        ("name=&email=xieyu%40gmail.com", "empty name"),
        ("name=xieyu&email=", "empty email"),
        ("name=xieyu&email=definitely-not-an-email", "invalid email"),
    ];
